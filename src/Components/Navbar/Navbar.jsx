  ...
  return (
    <div className="navbar">
      ...
      <ul className="nav-menu">
        ...
        <li><AnchorLink className='anchor-link' offset={50} href='#work'><p onClick={()=>setMenu("portofolio")}>Portfolio</p></AnchorLink> {menu==="portofolio" ?<img src={underline} alt=""></img>:<></>}</li>
